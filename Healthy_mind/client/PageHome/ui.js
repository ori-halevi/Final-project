...
const doctorsNamesDropdownMainDiv = document.getElementById("doctors-names-dropdown-main-div");

// קישורי אלמנטים להתמחויות
const specialtiesDropdownSuggestionsDiv = document.getElementById("specialties-dropdown-suggestions-div");
const specialtiesList = document.getElementById("doctors-specialties-list");
const specialtiesDropdownButton = document.getElementById("specialties-dropdown-button");
const specialtiesSearchBoxInput = document.getElementById("specialties-searchBox-input");
const specialtiesDropdownMainDiv = document.getElementById("specialties-dropdown-main-div");

// קישורי אלמנטים לערים
const citiesDropdownSuggestionsDiv = document.getElementById("city-dropdown-suggestions-div");
...
const languageDropdownSuggestionsDiv = document.getElementById("language-dropdown-suggestions-div");
...
const languageSearchBoxInput = document.getElementById("language-searchBox-input");
const languageDropdownMainDiv = document.getElementById("language-dropdown-main-div");

// קישורי אלמנטים למגדרים
const genderDropdownSuggestionsDiv = document.getElementById("gender-dropdown-suggestions-div");
...
selectItemFromList(doctorsNamesList, doctorsNamesDropdownButton, doctorsNamesDropdownSuggestionsDiv);
doctorsNamesDropdownButton.addEventListener("click", function () {
  toggleDropdown(doctorsNamesDropdownSuggestionsDiv);
});
closeDropdownOutsideClick(doctorsNamesDropdownMainDiv, doctorsNamesDropdownSuggestionsDiv);
...
selectItemFromList(specialtiesList, specialtiesDropdownButton, specialtiesDropdownSuggestionsDiv);
specialtiesDropdownButton.addEventListener("click", function () {
  toggleDropdown(specialtiesDropdownSuggestionsDiv);
});
closeDropdownOutsideClick(specialtiesDropdownMainDiv, specialtiesDropdownSuggestionsDiv);

// הפעלת הפונקציות עבור ערים
citiesSearchBoxInput.addEventListener("input", function () {
  filterList(citiesSearchBoxInput, citiesList);
});
selectItemFromList(citiesList, citiesDropdownButton, citiesDropdownSuggestionsDiv);
...
selectItemFromList(languageList, languageDropdownButton, languageDropdownSuggestionsDiv);
languageDropdownButton.addEventListener("click", function () {
  toggleDropdown(languageDropdownSuggestionsDiv);
});
closeDropdownOutsideClick(languageDropdownMainDiv, languageDropdownSuggestionsDiv);

// הפעלת הפונקציות עבור מגדרים
selectItemFromList(genderList, genderDropdownButton, genderDropdownSuggestionsDiv);
